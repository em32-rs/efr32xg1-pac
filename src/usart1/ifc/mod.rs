...
impl W {
    ...
    #[inline]
    pub fn tcmp0(&mut self) -> _TCMP0W {
        _TCMP0W { w: self }
    }
    #[doc = "Bit 15 - Clear TCMP1 Interrupt Flag"]
    #[inline]
    pub fn tcmp1(&mut self) -> _TCMP1W {
        _TCMP1W { w: self }
    }
    #[doc = "Bit 16 - Clear TCMP2 Interrupt Flag"]
    #[inline]
    pub fn tcmp2(&mut self) -> _TCMP2W {
        _TCMP2W { w: self }
    }
}

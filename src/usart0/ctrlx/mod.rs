...
impl W {
    ...
    #[doc = "Bit 0 - Debug Halt"]
    #[inline]
    pub fn dbghalt(&mut self) -> _DBGHALTW {
        _DBGHALTW { w: self }
    }
    #[doc = "Bit 1 - CTS Pin Inversion"]
    #[inline]
    pub fn ctsinv(&mut self) -> _CTSINVW {
        _CTSINVW { w: self }
    }
    #[doc = "Bit 2 - CTS Function Enabled"]
    #[inline]
    ...
    #[doc = "Bit 3 - RTS Pin Inversion"]
    #[inline]
    pub fn rtsinv(&mut self) -> _RTSINVW {
        _RTSINVW { w: self }
    }
}

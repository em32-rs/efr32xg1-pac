...
impl W {
    ...
    #[inline]
    pub fn dircng(&mut self) -> _DIRCNGW {
        _DIRCNGW { w: self }
    }
    #[doc = "Bit 3 - Clear AUXOF Interrupt Flag"]
    #[inline]
    pub fn auxof(&mut self) -> _AUXOFW {
        _AUXOFW { w: self }
    }
    ...
    #[inline]
    pub fn oqsterr(&mut self) -> _OQSTERRW {
        _OQSTERRW { w: self }
    }
}

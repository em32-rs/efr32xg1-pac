...
#[doc = r" Proxy"]
pub struct _XTIBIASENW<'a> {
    w: &'a mut W,
}
impl<'a> _XTIBIASENW<'a> {
...
impl W {
    ...
    #[doc = "Bits 4:6 - Reserved for internal use. Do not change."]
    #[inline]
    pub fn reglvl(&mut self) -> _REGLVLW {
        _REGLVLW { w: self }
    }
    #[doc = "Bit 9 - Reserved for internal use. Do not change."]
    #[inline]
    pub fn xtibiasen(&mut self) -> _XTIBIASENW {
        _XTIBIASENW { w: self }
    }
}

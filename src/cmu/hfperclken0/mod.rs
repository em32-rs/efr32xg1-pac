...
#[doc = r" Proxy"]
pub struct _CRYOTIMERW<'a> {
    w: &'a mut W,
}
impl<'a> _CRYOTIMERW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 4 - Analog Comparator 0 Clock Enable"]
    #[inline]
    pub fn acmp0(&mut self) -> _ACMP0W {
        _ACMP0W { w: self }
    }
    #[doc = "Bit 5 - Analog Comparator 1 Clock Enable"]
    #[inline]
    pub fn acmp1(&mut self) -> _ACMP1W {
        _ACMP1W { w: self }
    }
    #[doc = "Bit 6 - CryoTimer Clock Enable"]
    #[inline]
    pub fn cryotimer(&mut self) -> _CRYOTIMERW {
        _CRYOTIMERW { w: self }
    }
    #[doc = "Bit 7 - I2C 0 Clock Enable"]
    #[inline]
